...
function ParticipantAvatar({ avatarUrl, initials, size = "w-12 h-12", textSize = "text-sm" }) {
  ...
  return (
    <div
      className={`${size} rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold ${textSize} flex-shrink-0`}
    >
      {initials}
    </div>
  );
...
export default function ConversationList({ conversations, activeId, onSelect, userRole }) {
                ...
                >
                  <div className="relative flex-shrink-0">
                    <ParticipantAvatar
                      ...
                      initials={conv.participant.avatar}
                    />
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    ...
                    >
                      ...
                      {conv.lastMessage?.text ||
                        (conv.lastMessage?.media_url ? "📷 Image" : "No messages yet")}
                    </p>
                  </div>
